...
def main():
    ...
    config_object = ParseConfig(config_hash['mgm_model_fp'], config_hash['resfam_database_fp'],config_hash['pfam_database_fp'],config_hash['tigrfam_database_fp'])

    return(config_object)


class ParseConfig:
    def __init__(self,mgm,resfam,pfam,tigrfam):
